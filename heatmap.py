...
if __name__ == '__main__':
    ...
    # Behavioral Cloning
    # path = "./logs/bc_train/20220217-1434/policy_epoch_84.pth"
    # path = "./logs/bc_train/20220217-1434/bc_best.pth"
    # path = "./logs/dagger/20220218-1602/bc_best.pth"

    # Dagger with normal
    # path = "./logs/dagger/20220221-1018/policy_epoch_75.pth"
    ...
    # path = './logs/bc_train/20220222-2232/policy_epoch_4.pth'

    # Behavioral Cloning with LSTM
    # path = "./logs/bc/20220223-0110/policy_epoch_2000.pth"
    
    # DAGGER
    # path = "./logs/dagger/20220222-2219/policy_epoch_50.pth"

    # BC without LSTM
    path = "./logs/bc_train/20220223-0930/policy_epoch_610.pth"
    policy = reconstruct_policy(path)
