...
map_num = 0
# path = f"./buffers_msp/map_{map_num}_run_300_eps_0.npz"

# path = f"buffers_msp/map_0_run_300_eps_0.npz"
# path = "./datasets/post_red_obs_fix/map_0_run_300_rrt.npz"

# path =  "./datasets/post_red_obs_fix/map_0_400_RRT_gnn_save.npz"
# path = "./datasets/post_red_obs_fix/map_0_run_300_heuristic_eps_0.1.npz"

path = "./datasets/random_start_locations/train_vector.npz"
